...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openmatrix-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13209&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openmatrix-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openmatrix` can be installed with:

```
conda install openmatrix
```

It is possible to list all of the versions of `openmatrix` available on your platform with:
